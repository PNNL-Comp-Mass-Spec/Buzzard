...
namespace BuzzardLib.IO
{
	...
	{
		private static XmlDataDocument mobject_TriggerFileContents;
		...
		public static string GenerateTriggerFileBuzzard(classSampleData sample, BuzzardDataset dataset, DMSData dmsData, string destinationDir)
		{
			...
			return SaveFile(mobject_TriggerFileContents, sample, sample.DmsData.DatasetName, dataset, dmsData, destinationDir);
		}
		...
		/// <remarks>
		/// </remarks>
		private static XmlDataDocument GenerateXmlDoc(classSampleData sample, BuzzardDataset dataset, DMSData dmsData)
		{
		...
		private static string SaveFile(XmlDocument doc, classSampleData sample, string datasetName, BuzzardDataset dataset, DMSData dmsData, string outFilePath)
		{
