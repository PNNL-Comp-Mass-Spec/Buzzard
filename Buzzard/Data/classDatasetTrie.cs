...
{
    public class classDatasetTrie
    {        
        private classTrieNode mobj_root;

        public classDatasetTrie()
        {
            mobj_root = new classTrieNode();
        }
        /// <summary>
        ...
        {
            AddData(mobj_root, data.RequestName, data);
        }
        public void Clear()
        {
            RemoveNodes(mobj_root);
        }
        ...
        {
            return FindData(mobj_root, datasetName);
        }
